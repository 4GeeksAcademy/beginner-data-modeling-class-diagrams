# Beginner Data Modeling with Class Diagrams at 4Geeks Academy
...
Guided practice for **UML class diagrams** and **data modeling** using [diagram.4geeks.com](https://diagram.4geeks.com/). You will build one cumulative model for a **digital library** across ten steps.

This package has **no automated tests** and **no file delivery**. Work only in diagram.4geeks.com; use the README steps here for instructions. Compare your final diagram with the reference `classDiagram` in step **10 - Final Model**.
